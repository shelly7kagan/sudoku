...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_solve_board')) {
        Object.defineProperty(Module['ready'], '_solve_board', { configurable: true, get: function() { abort('You are getting _solve_board on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_solve_board', { configurable: true, set: function() { abort('You are setting _solve_board on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_free_array')) {
        Object.defineProperty(Module['ready'], '_free_array', { configurable: true, get: function() { abort('You are getting _free_array on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_free_array', { configurable: true, set: function() { abort('You are setting _free_array on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'solving_algorithm.wasm';
...
/** @type {function(...*):?} */
var _solve_board = Module["_solve_board"] = createExportWrapper("solve_board");

/** @type {function(...*):?} */
var _free_array = Module["_free_array"] = createExportWrapper("free_array");
